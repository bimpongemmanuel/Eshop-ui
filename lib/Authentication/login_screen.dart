            ...
            children: [
              ...
              TextField(
               ...
               const SizedBox(height: 10,),
                ...
                GestureDetector(child: const Text('Forgot Password ?',textAlign: TextAlign.right,style:  TextStyle(color: Colors.blue,fontWeight: FontWeight.bold),)),
                ...
                const SizedBox(height: 10,),
                 ...
                 Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: TextButton(
                    style: TextButton.styleFrom( surfaceTintColor: const Color(0xE1E43C08),shape:const RoundedRectangleBorder(), ),
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const SignupScreen(),));
                    },
                   child:  const Center(child: Text('Register',style: TextStyle(color: Color(0xE1E43C08),fontSize: 20),)),),
                ),
                   ...
                   Padding(
                     ...
                     const SizedBox(height: 10,),
                   const Text('Sign in with',style:  TextStyle(color: Colors.blue,fontSize: 15),),
